// ===========================================================
//  Google Sheets + Rowing Dashboard – main.js
// ===========================================================

// ===== GOOGLE SHEETS API CONFIG ============================

// 1) CLIENT_ID – vezmeš z Google Cloud Console → OAuth 2.0 Client IDs
//    vypadá jako: 1234567890-abcdefg.apps.googleusercontent.com
const CLIENT_ID = '740364404062-ovtbp9n06nejt682hlnb1g5hjs3qn129.apps.googleusercontent.com';

// 2) API_KEY – Create credentials → API key
const API_KEY = 'AIzaSyCLDYoPxOHIB0znePWvmo6kJS2OgZhGdrg';

// 3) ID spreadsheetu – z URL, tu už máš správně
// https://docs.google.com/spreadsheets/d/1b_WPjCTVGHW_q-4qBsVdBwUbVu7HxzzGUqNL2ZyCIPA/edit
const SPREADSHEET_ID = '1b_WPjCTVGHW_q-4qBsVdBwUbVu7HxzzGUqNL2ZyCIPA';

// 4) Název listu – uprav podle toho, jak se jmenuje sheet (spodní záložka)
//    např. "List1", "Results", "Data" ...
const SHEET_NAME = 'Results';

// 5) Scopes – potřebujeme číst i zapisovat
const SCOPES = 'https://www.googleapis.com/auth/spreadsheets';

// Google API klient a stav přihlášení
let tokenClient;
...
let allResults = [];      // všechny řádky z tabulky
...
// Naplnění dropdownu ve formuláři
...
// ===== GOOGLE API – AUTH & INIT ============================

// volá se z api.js (onload)
...
// volá se z gsi/client (onload)
function gsiLoaded() {
  tokenClient = google.accounts.oauth2.initTokenClient({
    client_id: CLIENT_ID,
    scope: SCOPES,
    callback: '', // nastavíme dynamicky
  });
  gisInited = true;
  maybeEnableAuth();
}
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Pozor: fetchResults NEVOLÁME hned – nejdřív musí proběhnout přihlášení
});
